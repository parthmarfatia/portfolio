...
export default function Home() {
  return (
    <>
      <Head>
        <title>Parth Marfatia | Home</title>
        ...
        <Layout className="pt-0 md:p-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              <AnimatedText
                text="Harnessing Code to Bring Visions to Life."
                className="!text-6xl !text-left 
              xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-!3xl 
              "
              />
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                As an adept Full-Stack Software Engineer, I strive to convert
                creative concepts into tangible web applications. Browse through
                my portfolio to experience my competency in JavaScript, HTML,
                CSS, React, and Node.js, embodied in a series of innovative
                projects.
              </p>
